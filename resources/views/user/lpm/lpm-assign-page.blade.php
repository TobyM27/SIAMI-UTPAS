...
<body class="font-sans">
            ...
            <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg">
                <ul class="py-1 text-gray-700">
                    <li>
                        ...
                        @csrf
                            <button type="submit" class="block px-4 py-2 text-sm hover:bg-gray-100">Logout</button>
                        </form>
                    </li>
                </ul>
            </div>
    ...
    <form action="{{ route('lpm.ami.store', $prodi) }}" method="POST" id="create_ami">
        @csrf
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input name="tanggal_mulai" id="tanggal_mulai" type="date" class="w-full mb-4">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="tanggal-mulai" class="font-bold">Tanggal Pelaksanaan AMI</label>
                                    <input name="tanggal_ami" id="tanggal_ami" type="date" class="w-full mb-4">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="tanggal-selesai">Tanggal Selesai</label>
                                    <input name="tanggal_akhir" id="tanggal_akhir" type="date" class="w-full mb-4">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="tanggal-selesai" class="font-bold">Nama Rektor</label>
                                    <input name="nama_rektor_utpas" type="text" class="w-full mb-4" placeholder="Masukkan nama rektor, beserta gelar">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="tanggal-selesai" class="font-bold">Nama Wakil Rektor</label>
                                    <input name="nama_warek_utpas" type="text" class="w-full mb-4" placeholder="Masukkan nama wakil rektor, beserta gelar">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="tanggal-selesai" class="font-bold">Nama Ketua LPM</label>
                                    <input name="nama_spmi" type="text" class="w-full mb-4" placeholder="Masukkan nama ketua LPM, beserta gelar">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <select name="auditee" id="auditee" class="w-full mb-4">
                                        <option value="" hidden>Pilih Auditee</option>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="ketua_auditor" id="ketua_auditor" class="w-full mb-4">
                                        <option value="" hidden>Pilih Ketua Auditor</option>
                                        @foreach ($data_user as $user)
                                            <option value="{{ $user['id']}}">{{ $user['name']}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="anggota_auditor" id="anggota_auditor" class="w-full mb-4">
                                        <option value="" hidden>Pilih Anggota Auditor</option>
                                        @foreach ($data_user as $user)
                                            <option value="{{ $user['id']}}">{{ $user['name']}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input name="link_file" type="url" class="w-full" placeholder="Masukkan link SK Auditor...">
                                </td>
                            </tr>
    ...
    <div class="text-center">
        <button class="bg-blue-500 px-2 rounded-md mt-24 text-white" type="submit" form="create_ami">Simpan</button>
    </div>
    <script>
        function addRow() {
